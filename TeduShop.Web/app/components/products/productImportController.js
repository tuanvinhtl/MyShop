(function (app) {
    ...
    productImportController.$inject = ['$scope', 'apiService', '$http', 'notificationService', '$state', 'commonService']

    function productImportController($scope, apiService, $http, notificationService, $state, commonService) {
